...
function renderCatalog(){
 ...
 $('catalog-meta').textContent=`${catalogData.courses.length} courses · ${catalogData.section_count} sections`;
 $('catalog-alert').hidden=!mismatch;
 $('catalog-alert').textContent=mismatch?'Catalog and workspace terms differ. Refresh the catalog for your workspace term before selecting sections.':'Separate CRNs per section. Companion requirements, pairing and eligibility unverified.';
