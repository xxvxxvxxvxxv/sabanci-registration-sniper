...
async function pollSeats(){
 ...
 }catch(e){$('monitor-state').textContent='Disconnected';$('seat-nav').textContent='Offline';$('monitor-state').classList.remove('on');monitorMessage('Local app unavailable. Monitoring state cannot be confirmed.',true);}
